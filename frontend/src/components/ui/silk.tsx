...
function SilkPlane({ speed, scale, color, noiseIntensity, rotation }: SilkPlaneProps) {
  ...
  useEffect(() => {
    ...
    if (mesh && mesh.material && mesh.material.uniforms) {
      ...
      mesh.material.uniforms.uNoiseIntensity.value = noiseIntensity;
      mesh.material.uniforms.uRotation.value = rotation;
      mesh.material.uniforms.uColor.value = new Color(...hexToNormalizedRGB(color));
    }
